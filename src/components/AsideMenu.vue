<template>
    <div  :class="['asideMenu',{active}]" @click="active=false">
        <div class="bar" @click.stop>
            <div class="up_bar">
                <div v-for="item of up_items" class="item buttonEffect" v-show="item.available" @click="item.function" :title="item.name">
            ...
            <div class="down_bar">
                <div v-for="item of down_items" class="item buttonEffect" v-show="item.available" @click="item.function" :title="item.name">
                    <img class="icon" :src="item.icon" />
                    <div class="text">{{ item.name }}</div>
                </div>
            </div>
